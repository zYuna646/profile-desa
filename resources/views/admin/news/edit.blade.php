            ...
            <x-admin.card title="Edit Berita">
                <form action="{{ route('admin.news.update', $news) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div>
                        ...
                        <x-admin.input type="text" name="title" id="title" class="mt-1 block w-full" :value="old('title', $news->title)" required autofocus />
                    ...
                    <div>
                        ...
                        <x-admin.textarea name="content" id="content" class="mt-1 block w-full h-64" required>{{ old('content', $news->content) }}</x-admin.textarea>
                    ...
                    <div>
                        ...
                        @if($news->image)
                            <div class="mt-2 mb-4">
                                <img src="{{ asset('storage/' . $news->image) }}" alt="{{ $news->title }}" class="h-32 w-auto rounded-lg object-cover">
                            </div>
                        @endif
                    ...
                    <div class="flex items-center">
                        <x-admin.checkbox name="is_active" id="is_active" value="1" :checked="old('is_active', $news->is_active)" />
