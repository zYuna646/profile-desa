<x-admin-layout>
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <x-admin.card title="Tambah Template Layanan">
                <x-slot name="header">
                ...
                <form method="POST" action="{{ route('admin.service-templates.store') }}" enctype="multipart/form-data">
                    @csrf
                                ...
                                <div class="variable-row grid grid-cols-12 gap-3 items-start">
                                    <div class="col-span-5">
                                        <x-admin.input 
                                            ...
                                            value="{{ old('variable_marks.0', 'NAMA_PEMOHON') }}" 
                                    ...
                                    <div class="col-span-6">
                                        <x-admin.input 
                                            ...
                                            value="{{ old('variable_descriptions.0', 'Nama lengkap pemohon') }}" 
                                ...
                                <div class="variable-row grid grid-cols-12 gap-3 items-start">
                                    <div class="col-span-5">
                                        <x-admin.input 
                                            ...
                                            name="variable_marks[]" 
                                            placeholder="NAMA_VARIABEL" 
                                            value="{{ old('variable_marks.1', 'NIK') }}" 
                                            :error="$errors->first('variable_marks.1')" 
                                        />
                                    </div>
                                    <div class="col-span-6">
                                        <x-admin.input 
                                            ...
                                            name="variable_descriptions[]" 
                                            placeholder="Deskripsi variabel" 
                                            value="{{ old('variable_descriptions.1', 'Nomor Induk Kependudukan') }}" 
                                            :error="$errors->first('variable_descriptions.1')" 
                                        />
                                    </div>
                                    <div class="col-span-1 flex items-center justify-center pt-2">
                                ...
                                <div class="variable-row grid grid-cols-12 gap-3 items-start">
                                    <div class="col-span-5">
                                        <x-admin.input 
                                            ...
                                            name="variable_marks[]" 
                                            placeholder="NAMA_VARIABEL" 
                                            value="{{ old('variable_marks.2', 'ALAMAT') }}" 
                                            :error="$errors->first('variable_marks.2')" 
                                        />
                                    </div>
                                    <div class="col-span-6">
                                        <x-admin.input 
                                            ...
                                            name="variable_descriptions[]" 
                                            placeholder="Deskripsi variabel" 
                                            value="{{ old('variable_descriptions.2', 'Alamat lengkap') }}" 
                                            :error="$errors->first('variable_descriptions.2')" 
                                        />
                                    </div>
                                    <div class="col-span-1 flex items-center justify-center pt-2">
                                        <button type="button" class="text-red-500 hover:text-red-700 delete-variable">
