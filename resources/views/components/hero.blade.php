...
<section class="hero-section relative overflow-hidden">
    ...
    <div class="absolute inset-0 z-0">
        ...
        >
        <!-- Gradient overlay -->
        <div class="absolute inset-0 bg-gradient-to-r from-jordy-blue-900/80 to-jordy-blue-800/60"></div>
    </div>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
            <defs>
                <pattern id="pattern" width="100" height="100" patternUnits="userSpaceOnUse">
                    <circle cx="10" cy="10" r="2" fill="currentColor" class="text-jordy-blue-500" />
                </pattern>
            </defs>
    ...
    <div class="container mx-auto px-4 py-24 md:py-32 relative z-20">
        <div class="grid md:grid-cols-2 gap-12 items-center">
            <div class="space-y-8 initial-animate delay-200">
                ...
                <p class="text-xl text-jordy-blue-100 max-w-lg initial-animate delay-500">
                    {{ $subtitle }}
                </p>
            ...
            <div class="relative group initial-animate delay-1000">
                <div class="absolute -inset-1 bg-gradient-to-r from-jordy-blue-400 to-jordy-blue-600 rounded-lg blur opacity-25 group-hover:opacity-50 transition duration-300"></div>
                <div class="relative overflow-hidden rounded-lg shadow-xl">
                    ...
                    >
                    <div class="absolute inset-0 bg-gradient-to-t from-jordy-blue-900/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                </div>
            </div>
        </div>
    </div>
