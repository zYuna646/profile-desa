...
<div class="relative bg-white overflow-hidden">
    ...
    <div class="hidden lg:block lg:absolute lg:inset-y-0 lg:h-full lg:w-full">
        <div class="relative h-full text-jordy-blue-200">
        ...
        <div class="container mx-auto px-4">
            <div class="lg:grid lg:grid-cols-12 lg:gap-8 items-center">
                <div class="lg:col-span-5 text-center lg:text-left">
                    <h2 class="text-3xl font-extrabold text-jordy-blue-900 sm:text-4xl">
                        Sambutan Kepala Desa
                    </h2>
                    <div class="mt-3 max-w-3xl mx-auto lg:mx-0">
                        <p class="text-xl text-jordy-blue-700 mb-6">
                            {{ $message }}
                        </p>
                        <div class="mt-8">
                            <div class="inline-flex items-center">
                                <span class="h-px w-8 bg-jordy-blue-500 mr-4"></span>
                                <span class="font-bold text-jordy-blue-900">{{ $name }}</span>
                                <span class="h-px w-8 bg-jordy-blue-500 ml-4"></span>
                            </div>
                            <p class="text-jordy-blue-600 mt-1">Kepala Desa</p>
                        </div>
                    </div>
                </div>
                <div class="mt-12 lg:mt-0 lg:col-span-7">
                    <div class="relative mx-auto w-full rounded-lg shadow-lg overflow-hidden lg:max-w-md">
                        <div class="absolute inset-0 bg-gradient-to-r from-jordy-blue-400 to-jordy-blue-600 mix-blend-multiply opacity-25"></div>
                        <div class="relative">
                            <img 
                        ...
                        <div class="absolute inset-x-0 bottom-0 p-6 bg-gradient-to-t from-jordy-blue-900 to-transparent">
                            <div class="flex items-center">
                                <div class="ml-4">
                                    <p class="text-sm font-medium text-white">
                                        {{ $name }}
                                    </p>
                                    <p class="text-xs text-jordy-blue-200">
                                        Kepala Desa
                                    </p>
                                </div>
                            </div>
